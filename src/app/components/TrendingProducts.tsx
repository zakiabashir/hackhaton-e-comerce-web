    ...
    <div className="w-full bg-white py-20">
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-pink-100 p-8 flex flex-col  relative h-[200px]">
          ...
          <button className="text-pink-600 underline text-left text-lg font-medium">Shop Now</button>
          <Image
            src="/images/voucher1.png"
            alt="Voucher Image"
            width={180}
            height={150}
            className="absolute bottom-2 top-8  right-0 object-contain"
          />
        </div>
        ...
        <div className="bg-pink-100 p-8 flex flex-col relative h-[200px]">
          <h3 className="text-[#3F509E] text-2xl font-bold mb-4">23% Off in all products</h3>
   {/* Button */}
   <button className="text-pink-600 underline text-lg  text-left font-medium ">
    View Collection
  </button>
          <Image
            ...
            width={250}
            height={250}
             className="  absolute bottom-2 top-24 right-0 object-contain"
          />
        </div>
          ...
          {exclusiveProducts.map((product) => (
            ...
            >
              <Image
                ...
                width={80}
                height={80}
                className=" bg-gray-200 m-2 object-contain mr-4"
              />
              <div  >
